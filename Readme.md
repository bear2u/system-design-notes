...
# [시스템 디자인 인터뷰 - 실전 가이드 (1권 및 2권)](https://bytebytego.com/courses/system-design-interview)
이 노트는 『System Design Interview』 도서인 [1권 및 2권 2판](https://www.goodreads.com/book/show/54109255-system-design-interview-an-insider-s-guide)을 바탕으로 정리했습니다.

노트는 여기에서도 확인할 수 있습니다: https://pagefy.io/system-design/system-design-interview-by-alex-xu

**참고:** 이 노트는 계속 작성 및 개선 중입니다.


 * [1장 - 사용자 0명에서 수백만 명까지 확장하기](./01.%20Scaling/)
 * [2장 - 개략적 규모 추정](./02.%20Back%20Of%20the%20Envelope%20Estimation/)
 * [3장 - 시스템 디자인 인터뷰 프레임워크](./03.%20System%20Design%20Framework/)
 * [4장 - 요청 제한기 설계](./04.%20Rate%20Limiter//)
 * [5장 - 일관 해싱 설계](./05.%20Consistent%20Hashing/)
 * [6장 - 키-값 저장소 설계](./06.%20Key-Value%20Store/)
 * [7장 - 분산 시스템용 고유 ID 생성기 설계](./07.%20Unique-Id%20Generator/)
 ...
 * [13장 - 검색 자동완성 시스템 설계](./13.%20Search%20Autocomplete/)
 * [14장 - YouTube 설계](./14.%20Youtube/)
 * [15장 - Google Drive 설계](./15.%20Google%20Drive/)
 * [16장 - 근접 서비스](./16.%20Proximity%20Service/)
 * [17장 - 주변 친구](./17.%20Nearby%20Friends/)
 * [18장 - Google Maps 설계](./18.%20Google%20Maps/)
 * [19장 - 분산 메시지 큐](./19.%20Distributed%20Message%20Queue/)
 * [20장 - 메트릭 모니터링 및 알림 시스템](./20.%20Metrics%20Monitoring%20and%20Alerting%20System/)
 ...
 * [24장 - S3 유사 객체 스토리지](./24.%20S3-like%20Object%20Storage/)
 * [25장 - 실시간 게임 리더보드](./25.%20Real-time%20Gaming%20Leaderboard/)
 * [26장 - 결제 시스템](./26.%20Payment%20System/)
 * [27장 - 디지털 지갑](./27.%20%20Digital%20Wallet/)
...
- [Uber 요청 제한기](https://github.com/uber-go/ratelimit/blob/master/ratelimit.go)


### 일관 해싱
- [일관 해싱](https://tom-e-white.com/2007/11/consistent-hashing.html)
- [CS168: 개론 및 일관 해싱]( http://theory.stanford.edu/~tim/s16/l/l1.pdf)
- [Apache Cassandra](http://www.cs.cornell.edu/Projects/ladis2009/papers/Lakshman-ladis2009.PDF)
- [Discord 확장 사례](https://blog.discord.com/scaling-elixir-f9b8e1e7c29b)
...
- [Amazon Dynamo DB의 디자인 패턴](https://www.youtube.com/watch?v=HaEPXoXVf2k)
- [Amazon Dynamo DB 내부 동작](https://www.youtube.com/watch?v=yvBR71D0nAQ)
...
- [Flannel: Slack 확장을 위한 애플리케이션 수준 엣지 캐시](https://slack.engineering/flannel-an-application-level-edge-cache-to-make-slack-scale/)
...
- [Facebook 비디오 브로드캐스팅](https://engineering.fb.com/ios/under-the-hood-broadcasting-live-video-to-millions/)
- [대규모 Netflix 비디오 인코딩](https://netflixtechblog.com/high-quality-video-encoding-at-scale-d159db052746)
- [Netflix 샷 기반 인코딩](https://netflixtechblog.com/optimized-shot-based-encodes-now-streaming-4b9464204830)
